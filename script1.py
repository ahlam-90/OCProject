...
# construction de la requête ping en fonction du système/OS sur lequel le programme est en cours d'exécution
# platform.system() renvoie le nom du système d'exploitation
